...
struct command_info cmd_info[] =
{
	...
	{ "delete_shop",				do_shop_delete,				0,	POS_DEAD,	GM_LOW_WIZARD },
	{ "update_shop",				do_shop_update,				0,	POS_DEAD,	GM_IMPLEMENTOR },
#endif
	{ "who",		do_who,			0,			POS_DEAD,	GM_LOW_WIZARD	},
	{ "w",		do_who,			0,			POS_DEAD,	GM_LOW_WIZARD	},
#if defined(ENABLE_AFFECT_POLYMORPH_REMOVE)
	{ "remove_polymorph",	do_remove_polymorph,	0,		POS_DEAD,	GM_PLAYER	},
#endif
#ifdef ENABLE_OFFLINE_SHOP_HIDE
	{ "show_hide_shops",			do_show_hide_shops,				0,	POS_DEAD,	GM_PLAYER },
#endif
	{ "jmk",		do_force_logout,			0,			POS_DEAD,	GM_PLAYER	},
	...
	{ "ip",		do_item_purge,		0,			POS_DEAD,	GM_HIGH_WIZARD	},
	{ "group",		do_group,		0,			POS_DEAD,	GM_HIGH_WIZARD	},
	{ "g",		do_group,		0,			POS_DEAD,	GM_HIGH_WIZARD	},
	...
	{ "a",	do_advance,		0,			POS_DEAD,	GM_IMPLEMENTOR		},
	...
	// ADD_COMMAND_SLOW_STUN
	{ "stun",		do_stun,		0,			POS_DEAD,	GM_GOD	},
	{ "slow",		do_slow,		0,			POS_DEAD,	GM_GOD	},
	// END_OF_ADD_COMMAND_SLOW_STUN
...
#ifdef __ENABLE_BATTLE_FIELD__
	{ "restart_battle",	do_restart,		SCMD_RESTART_BATTLE,	POS_DEAD,	GM_PLAYER	},
	{ "battle_force_close", do_battle_force_close, 0, POS_DEAD, GM_IMPLEMENTOR },
	{ "battle_set_event", do_battle_set_event, 0, POS_DEAD, GM_IMPLEMENTOR },
#endif
	...
	{ "invisible",	do_invisibility,	0,			POS_DEAD,	GM_GOD	},
	{ "inv",	do_invisibility,	0,			POS_DEAD,	GM_GOD	},
	...
	{ "poly",	do_polymorph,		0,			POS_DEAD,	GM_LOW_WIZARD	},
	{ "polyitem",	do_polymorph_item,	0,			POS_DEAD,	GM_IMPLEMENTOR },
	{ "polyi",	do_polymorph_item,	0,			POS_DEAD,	GM_IMPLEMENTOR },
	{ "priv_empire",	do_priv_empire,		0,			POS_DEAD,	GM_IMPLEMENTOR	},
	{ "priv_e",	do_priv_empire,		0,			POS_DEAD,	GM_IMPLEMENTOR	},
	{ "priv_guild",	do_priv_guild,		0,			POS_DEAD,	GM_IMPLEMENTOR	},
	{ "priv_g",	do_priv_guild,		0,			POS_DEAD,	GM_IMPLEMENTOR	},
	...
	// BLOCK_CHAT
	{ "vote_block_chat", do_vote_block_chat,		0,			POS_DEAD,	GM_LOW_WIZARD	},
	...
	{ "mmob",			do_monarch_mob,			0, 	POS_DEAD,	GM_GOD},
	...
	{ "cann",				do_can_dead,	0,	POS_DEAD,		GM_IMPLEMENTOR},
	{ "can",				do_can_dead,	0,	POS_DEAD,		GM_IMPLEMENTOR},

	{ "full_set",	do_full_set, 0, POS_DEAD,		GM_IMPLEMENTOR},
	{ "full",	do_full_set, 0, POS_DEAD,		GM_IMPLEMENTOR},
	...
	{ "petextrabns",	do_PetExtraBns,		0,	POS_DEAD,	GM_PLAYER },
#endif
