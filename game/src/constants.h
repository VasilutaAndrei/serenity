...
const int STONE_INFO_MAX_NUM = 15;
...
extern const TApplyInfo		aApplyInfo[MAX_APPLY_NUM + 1];
...
extern const DWORD		exp_support_table[121];
extern const DWORD		weapon_support_table[121];
extern const DWORD		armour_support_table[121];
#endif
extern const DWORD*		exp_table;

#ifdef NEW_PET_SYSTEM
extern DWORD		exppet_table_common[PLAYER_MAX_LEVEL_CONST + 1];
extern DWORD*		exppet_table;
extern const DWORD		Pet_SKill_TablePerc[3][20];
extern const DWORD		Pet_Skill_Table[18][23];
extern const DWORD		Pet_Table[8][2];
#endif
...
#define ARMOR_COLLECTION_MAX_COUNT 12
