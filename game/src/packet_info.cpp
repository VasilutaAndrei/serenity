...
#ifndef DISABLE_SEQUENCE_SYSTEM
...
CPacketInfoCG::CPacketInfoCG()
{
	...
	Set(HEADER_CG_ADMIN_BAN_MANAGER, sizeof(TPacketCGAdminBanManger), "TPacketCGAdminBanManger", true);
#endif
	...
	Set(HEADER_CG_ATTENDANCE_REWARD, sizeof(BYTE), "RequestAttendanceReward", true);
#endif
#ifdef __ENABLE_BATTLE_FIELD__
	Set(HEADER_CG_REQUEST_ENTER_BATTLE, sizeof(BYTE), "RequestEnterBattle", true);
	Set(HEADER_CG_REQUEST_EXIT_BATTLE, sizeof(BYTE), "RequestExitBattle", true);
#endif
