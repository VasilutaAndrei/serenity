...
int		g_aiItemDestroyTime[ITEM_DESTROY_TIME_MAX] = {15, 15, 15}; // autoitem, dropgold, dropitem
...
void config_init(const string& st_localeServiceName)
{
	...
	if(!gHackCheckEnable)	// Hack üũ�� ��Ȱ��ȭ�� ���
	{
		assert(test_server);	// �׽�Ʈ ������ �ƴ϶�� assert
	}
