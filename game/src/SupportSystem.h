...
protected:
	...
	CSupportActor(LPCHARACTER owner, DWORD vnum);
...
private:
	...
	DWORD			m_dwIntSkill;
	DWORD			m_dwIntSkillBonus;
	DWORD			m_dwGiveSuppTime;
	DWORD			m_dwlevel;
	DWORD			m_dwNextExp;
	DWORD			m_dwduration;
...
public:
	...
	CSupportActor*	Summon(DWORD mobVnum, LPITEM pSummonItem, bool bSpawnFar);
