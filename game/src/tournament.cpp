...
static const char* LC_TRANSLATE(const char* key) /* Configurable */
{
	...
	LC_TRANSLATE["TOURNAMENT_CATEGORY_LOW"]								= "Incepator";	
	LC_TRANSLATE["TOURNAMENT_CATEGORY_MEDIUM"]							= "Medium";	
	LC_TRANSLATE["TOURNAMENT_CATEGORY_HARD"]							= "Greu";

	LC_TRANSLATE["TOURNAMENT_TEAM_MEMBER_RED"]							= "Rosu";		
	LC_TRANSLATE["TOURNAMENT_TEAM_MEMBER_BLUE"]							= "Albastru";	
	
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_BEFORE_START"]				= "<Turneul PvP pentru categoria %s v-a incepe in %d minute>";

	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_START_LINE_1"]				= "<Turneul PvP> Categoria %s a inceput, mult succes celor doua echipa.";
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_START_LINE_2"]				= "<Turneul PvP> Durata turneului este de %d minute.";
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_START_LINE_3"]				= "<Turneul PvP> Pentru a fii spectatori, doar apasati pe questul din stanga.";

	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_NOT_STARTED_LINE_1"]			= "<Turneul PvP> Numarul de jucatori este insuficient pentru categoria [%s] , lupta nu v-a incepe.";
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_NOT_STARTED_LINE_2"]			= "<Turneul PvP> La ora %s, categoria [%s] v-a incepe.";
	
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_FINISHED_LINE_1"]				= "<Turneul PvP pentru categoria %s s-a sfarsit>";
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_FINISHED_LINE_2"]				= "<Turneul PvP> La ora %s, categoria [%s] v-a incepe.";

	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_WINNER_SAME"]					= "<Turneul PvP> Lupta sa incheiat la egalitate, ambele echipe au acelasi numar de membri ramasi in picioare.";
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_WINNER_NOT_EXIST"]			= "<Turneul PvP> Nici o echipa nu a castigat turneul, deoarece nu au mai ramas membri in picioare.";
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_WINNER_SUCCES"]				= "<Turneul PvP> Felicitari echipei %s, ei au castigat turneul cu %d membri in picioare.";

	LC_TRANSLATE["TOURNAMENT_MEMBER_REMAINING_LIFE"]					= "<Turneul PvP> Ai %d vieti.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_FINISHED_LIFE_LINE_1"]				= "<Turneul PvP> Nu mai ai nici o viata.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_FINISHED_LIFE_LINE_2"]				= "<Turneul PvP> Ati fost eliminat din turneu, data viitoare sa fi mai pregatit!";
	LC_TRANSLATE["TOURNAMENT_MEMBER_DIVIDED"]							= "<Turneul PvP> Ai fost repartizat in echipa %s ";

	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_DUEL"]						= "<Turneul PvP> Nu puteti incepe un duel in aceasta mapa.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_PARTY"]						= "<Turneul PvP> Nu puteti face o grupa in aceasta mapa.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_RING_MARRIAGE"]				= "<Turneul PvP> Nu puteti folosi inelul de nunta in aceasta mapa.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_POLY"]						= "<Turneul PvP> Nu v-a puteti transforma in aceasta harta.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_CHANGE_PKMODE"]				= "<Turneul PvP> Nu puteti folosii Optiunile PVP in aceasta harta.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_MOUNT"]						= "<Turneul PvP> Nu puteti calarii un mount in aceasta harta.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_HORSE"]						= "<Turneul PvP> Nu puteti calarii un cal in aceasta harta.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_EXIT_OBSERVER_MODE_LINE_1"]	= "<Turneul PvP> Nu puteti modifica modul de observare in aceasta harta.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_EXIT_OBSERVER_MODE_LINE_2"]	= "<Turneul PvP> Daca doriti sa iesiti din harta, utilizati questul din stanga.";
	
	LC_TRANSLATE["TOURNAMENT_MEMBER_OPEN_REWARD_WRONG_SIZE"]			= "<Turneul PvP> Nu poti folosi asta deoarece trebuie sa ai %d sloturi libere in inventar.";	
	LC_TRANSLATE["TOURNAMENT_MEMBER_CANNOT_USE_ITEM"]					= "<Turneul PvP> Nu poti folosi %s deoarece este restrictionat.";	
	LC_TRANSLATE["TOURNAMENT_INSERT_LOG_WINNERS"]						= "Nume: %s | Level: %d | IP: %s | Vieti Ramase: %d | Echipa: %s";	
	
#ifdef ENABLE_EXTRA_LIVES_TOURNAMENT
	LC_TRANSLATE["TOURNAMENT_MEMBER_ADD_EXTRA_LIVES_ERROR_LINE_1"]		= "<Turneul PvP> Nu puteti folosi acest element aici, trebuie sa faceti asta inainte de a fi aici.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_ADD_EXTRA_LIVES_ERROR_LINE_2"]		= "<Turneul PvP> Ai facut deja asta recent, nu poti face din nou asa de repede, trebuie sa termini toate vietile suplimentare.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_ADD_EXTRA_LIVES_ERROR_LINE_3"]		= "<Turneul PvP> Total vieti suplimentare: %d din %d.";	
	LC_TRANSLATE["TOURNAMENT_MEMBER_ADD_EXTRA_LIVES_SUCCES"]			= "<Turneul PvP> Felicitari, au fost adaugate +%d vieti in turneu, acestea sunt disponibile pentru %d participari.";	
#endif
...
const int TOURNAMENT_INFO_TIMER[TOURNAMENT_MAX_CATEGORY][4] = /* Configurable */
{
	...
	*/
	{ 15, 10,	15, 30 }, // TOURNAMENT_CATEGORY_LOW
	{ 16, 10,	16, 30 }, // TOURNAMENT_CATEGORY_MEDIUM
	{ 17, 10,	17, 40 }  // TOURNAMENT_CATEGORY_HARD
};
...
bool CTournamentPvP::CanUseItem(LPCHARACTER ch, LPITEM item)
{
	...
	switch (item->GetVnum())
	{
		...
		case TOURNAMENT_ITEM_EXTRA_LIVES:
		{
			...
			ch->RemoveSpecifyItem(TOURNAMENT_ITEM_EXTRA_LIVES, 1);
		}
		break;
#endif
