...
class CInputMain : public CInputProcessor
{
	...
	protected:
		...
		void		SendAdminBanManager(LPCHARACTER ch, const char* c_pData);
#endif
		...
		void		UpgradeItemsStorageCheckin(LPCHARACTER ch, const char * c_pData);
		void		UpgradeItemsStorageCheckout(LPCHARACTER ch, const char * c_pData);
		void		UpgradeItemsStorageItemMove(LPCHARACTER ch, const char * data);
#endif
