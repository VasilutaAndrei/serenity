...
enum
{
	...
	HEADER_CG_LOGIN2				= 117,
	HEADER_CG_DUNGEON				= 110,
	HEADER_CG_LOGIN3				= 119,
	...
	HEADER_CG_OXEVENT_MANAGER		= 120,
#endif
#ifdef ENABLE_ADMIN_BAN_MANAGER
	HEADER_CG_ADMIN_BAN_MANAGER		= 126,
#endif
#ifdef __UPGRADE_ITEMS_STORAGE__
	HEADER_CG_UPGRADE_ITEMS_STORAGE_CHECKIN		= 127,
	HEADER_CG_UPGRADE_ITEMS_STORAGE_CHECKOUT	= 128,
	HEADER_CG_UPGRADE_ITEMS_STORAGE_ITEM_MOVE	= 129,
#endif
...
//	HEADER_CG_RUNUP_MATRIX_ANSWER	= 201,
...
#endif
#ifdef __UPGRADE_ITEMS_STORAGE__
	HEADER_GC_UPGRADE_ITEMS_STORAGE_SET		= 160,
	HEADER_GC_UPGRADE_ITEMS_STORAGE_DEL		= 161,
	HEADER_GC_UPGRADE_ITEMS_STORAGE_OPEN	= 162,
#endif
	...
	HEADER_GC_SKILL_MOTION					= 157,
	HEADER_GC_IGNORE_NEXT_SKILL_COOLDOWN	= 158,
...
#ifdef __UPGRADE_ITEMS_STORAGE__
typedef struct command_upgrade_items_storage_checkout
{
	BYTE	bHeader;
	WORD	bSafePos;
	TItemPos	ItemPos;
} TPacketCGUpgradeItemsStorageCheckout;

typedef struct command_upgrade_items_storage_checkin
{
	BYTE	bHeader;
	WORD	bSafePos;
	TItemPos	ItemPos;
} TPacketCGUpgradeItemsStorageCheckin;
#endif
...
enum
{
	HEADER_CG_REQUEST_ENTER_BATTLE  = 217,
	HEADER_CG_REQUEST_EXIT_BATTLE  = 218,
	
	HEADER_GC_BATTLE_ZONE_INFO = 222,
};
...
//ceva buffi
typedef struct SPacketGCIgnoreNextSkillCooldown
{
	BYTE	header;
} TPacketGCIgnoreNextSkillCooldown;

typedef struct SPacketGCSkillMotion
{
	BYTE	header;
	DWORD	dwVID;
	long	lX;
	...
	BYTE	bSkillLevel;
	BYTE	bSkillGrade;
} TPacketGCSkillMotion;

#ifdef ENABLE_SHOW_CHEST_DROP
enum
{
	HEADER_CG_CHEST_DROP_INFO = 216,
