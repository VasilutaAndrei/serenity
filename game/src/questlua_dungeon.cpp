...
namespace quest
{
...
#ifdef ENABLE_D_NJGUILD
	int dungeon_new_jump_guild(lua_State* L)
	{
	...
	int dungeon_get_damage_from_race(lua_State* L)
	{
		if (!lua_isnumber(L, 1))
			return 0;
	...
	int dungeon_get_damage_from_affect(lua_State* L)
	{
		if (!lua_isnumber(L, 1))
			return 0;
	...
	int dungeon_set_damage_from_race(lua_State* L)
	{
		if (!lua_isnumber(L, 1) || !lua_isnumber(L, 2))
			return 0;
	...
	int dungeon_set_damage_from_affect(lua_State* L)
	{
		if (!lua_isnumber(L, 1) || !lua_isnumber(L, 2))
			return 0;
	...
	int dungeon_unset_damage_from_race(lua_State* L)
	{
		if (!lua_isnumber(L, 1) || !lua_isnumber(L, 2))
			return 0;
	...
	int dungeon_unset_damage_from_affect(lua_State* L)
	{
		if (!lua_isnumber(L, 1) || !lua_isnumber(L, 2))
			return 0;
	...
	int dungeon_reset_damage_from_race(lua_State* L)
	{
		if (!lua_isnumber(L, 1))
			return 0;
	...
	int dungeon_reset_damage_from_affect(lua_State* L)
	{
		if (!lua_isnumber(L, 1))
			return 0;
	...
	int dungeon_is_available0(lua_State* L)
	{
		CQuestManager& q = CQuestManager::instance();
		LPDUNGEON pDungeon = q.GetCurrentDungeon();
