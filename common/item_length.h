...
#endif
	ITEM_ANTIFLAG_SHOP_SECONDARY = (1 << 19),
	ITEM_ANTIFLAG_SHOP_TRIPLE 	 = (1 << 20),
};
...
#endif
#ifdef __COSTUME_RING_SYSTEM__
	WEARABLE_COSTUME_RING1 = (1 << 15),
	WEARABLE_COSTUME_RING2 = (1 << 16),
#endif
};
