...
enum EMisc
{
	...
	SKILL_MAX_NUM			= 255,
	SKILLBOOK_DELAY_MIN		= 0,
	SKILLBOOK_DELAY_MAX		= 0,
	SKILL_MAX_LEVEL			= 40,
...
enum EParts
{
	...
	PART_HEAD,
	PART_HAIR,
	//#ifdef __SASH_SYSTEM__ [remove manually in-case you disable them]
	PART_SASH,
	//#endif
...
enum EApplyTypes
{
	...
	APPLY_ATTBONUS_WOLFMAN,		//94 수인족에게 강함
	APPLY_RESIST_WOLFMAN,		//95 수인족에게 저항
	APPLY_RESIST_CLAW,			//96 CLAW무기에 저항
#endif
...
//new_chest_boss
 ...
 EXCELENT_BOSS2 = 49092,
 EXCELENT_USINGS2 = 3,
 
 EXCELENT_BOSS3 = 49093,
 EXCELENT_USINGS3 = 3,
 
 EXCELENT_BOSS4 = 49084,
 EXCELENT_USINGS4 = 3,
...
typedef struct SItemPos
{
	...
	bool IsUpgradeItemsStorage() const
	{
		return window_type == UPGRADE_ITEMS_STORAGE+5;
	}
#endif	
